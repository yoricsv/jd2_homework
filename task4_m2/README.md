...
Write a program that receives consumption data through command line arguments.
The program should add data to the database and display the expense table.
