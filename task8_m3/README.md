...
Create an inheritance structure that has a base class and children.

1. Customize the mapping and implement a hierarchy strategy for a single table.
2. Customize the mapping and implement a "Table per subclass" strategy.
3. Customize the mapping and implement a "Table per class" strategy.

Write the logic for changing various entities from this hierarchy.
